...
export default class Camera {
    ...
    constructor(windowWidth: any, windowHeight: any, view: string, multipleViewsViewport: THREE.Vector4, target: THREE.Vector3, initialOrientation: Orientation,
                orientationMin: Orientation, orientationMax: Orientation, initialDistance: number, distanceMin: number, distanceMax: number, initialZoom: number,
                zoomMin: number, zoomMax: number, initialFov: number, near: number, far: number) {

        this.windowWidth = windowWidth;
        this.windowHeight = windowHeight;
        this.view = view;
        this.multipleViewsViewport = multipleViewsViewport;
        this.target = target;
    ...
    updateTarget(targetIncrement: THREE.Vector3) {
    ...
    updateDistance(distanceIncrement: number) {
