...
export default class Floor {
    ...
    onLoad() {
        ...
        //create a door
        this.door = new Door(Default_data.doorTextureUrl);

        this.elevator3D = new Elevator();

        // Create a bridge
        this.bridge = new Door(Default_data.bridgeTextureUrl);
        ...
        for (let room of this.rooms) {
            ...
            for (let i = room.dimensions.top.x; i <= room.dimensions.bottom.x; i++) {
                ...
                if (room.dimensions.top.y == 0 && i == 0) {
                    ...
                    if (room.dimensions.bottom.y == 0 && i == this.size.height) {
                        this.map[i][room.dimensions.top.y] = 2;
                    } else {
                        ...
                        if (i == room.dimensions.top.x) {
                            ...
                            if (i == room.dimensions.bottom.x) {
                                //checkout if it is in the building west wall
                                if (room.dimensions.top.y == 0) {
                                    this.map[i][room.dimensions.top.y] = 3;
                                } else {
                                    this.map[i][room.dimensions.top.y] = 2;
                                }
            ...
            for (let i = room.dimensions.bottom.y; i >= room.dimensions.top.y; i--) {
                ...
                if (room.dimensions.bottom.x == this.size.width && i == 0) {
                    ...
                    if (room.dimensions.top.x == this.size.width && i == this.size.height) {
